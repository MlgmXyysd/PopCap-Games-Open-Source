...
/*
	...
	2009.07.29: Added BackgroundInfo structure and bgInfo argument,
	            for improved transparent rendering
	2009.10.27: Added opaqueRect argument, another transparency improvement
	2009.11.10: Added ERenderMode enum and setRenderMode method, to help
	            visually debug dirtyrect problems.
*/
...
public:
	...
	struct _OSMExport BackgroundInfo {
		enum
		{
	...
	*/
	void render(unsigned char* destination, int destRowSpan, int destDepth, Awesomium::Rect* renderedRect = 0, BackgroundInfo* bgInfo = 0, Awesomium::Rect* opaqueRect = 0);
