...
/*
	...
	2009.10.27: Added opaqueRect argument, for transparency improvement
	2009.11.10: Added renderMode field and setRenderMode method, for debugging
*/
...
class WebViewProxy : public WebViewDelegate
{
	...
	Awesomium::WebView::ERenderMode renderMode;
...
public:
	...
	gfx::Rect render(Awesomium::WebView::BackgroundInfo* bgInfo, Awesomium::Rect* opaqueRect);

	void copyRenderBuffer(unsigned char* destination, int destRowSpan, int destDepth);

	void renderAsync();

	void renderSync(unsigned char* destination, int destRowSpan, int destDepth, Awesomium::Rect* renderedRect, Awesomium::WebView::BackgroundInfo* bgInfo, Awesomium::Rect* opaqueRect);
	...
	void setRenderMode(Awesomium::WebView::ERenderMode renderMode);
